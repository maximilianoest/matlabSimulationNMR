...
r1RatesFileName  ...
    = "20230427_SM_MW_SP_histCompartmentAndCrossR1";
...
r1Data.r1_SP_WM = factorProteinWM * r1Data.fieldStrengths ...
    .^(-exponentProteinWM);
r1Data.wmFitParams = [factorProteinWM exponentProteinWM];
r1Data.r1_SP_WmHighField = highFieldWmFactor * r1Data.fieldStrengths ...
    .^(-highFieldWmExponent);
r1Data.wmFitParamsHighField = [highFieldWmFactor highFieldWmExponent];
% saving GM
r1Data.r1_SP_GM = factorProteinGM * r1Data.fieldStrengths ...
    .^(-exponentProteinGM);
r1Data.gmFitParams = [factorProteinGM exponentProteinGM];
r1Data.r1_SP_GmHighField = highFieldGmFactor * r1Data.fieldStrengths ...
    .^(-highFieldGmExponent);
r1Data.gmFitParamsHighField = [highFieldGmFactor highFieldGmExponent];
% saving Avg
r1Data.r1_SP_Avg = avgFactorProtein * r1Data.fieldStrengths ...
    .^(-avgExponentProtein);
r1Data.avgFitParams = [avgFactorProtein avgExponentProtein];
r1Data.r1_SP_AvgHighField = highFieldAvgFactor * r1Data.fieldStrengths ...
    .^(-highFieldAvgExponent);
r1Data.avgFitParamsHighField = [highFieldAvgFactor highFieldAvgExponent];
