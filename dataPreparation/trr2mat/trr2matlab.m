...
outputEveryIntFrames = 1; % default to outputting every 100 frames
for n = 1:numel(noF)
...
outputEveryIntFrames = 5000; % default to outputting every 100 frames
