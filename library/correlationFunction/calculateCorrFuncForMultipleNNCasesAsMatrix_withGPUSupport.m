function sumCorrelationFunctions = ...
    calculateCorrFuncForMultipleNNCasesAsMatrix_withGPUSupport(...
    sphericalHarmonic,nearestNeighbourCases)
...
fftSphericalHarmonic = fft(gpuArray(complex(sphericalHarmonic)) ...
    ,zeroPaddingLength,2);
...
parfor nearestNeighboursCount = 1:length(nearestNeighbourCases)
