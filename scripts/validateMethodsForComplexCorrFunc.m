...
if ~exist('nearestNeighbourCases','var')
    ...
    for nearestNeighbours = nearestNeighbourCases
        ...
        correlationFunctionsZerothOrder.(key) = zeros(1,timeSteps ...
            ,'like',double(1j));
        correlationFunctionsZerothOrderSingle.(key) = zeros(1,timeSteps ...
            ,'like',single(1j));
        correlationFunctionsFirstOrder.(key) = zeros(1,timeSteps ...
            ,'like',double(1j));
        correlationFunctionsFirstOrderSingle.(key) = zeros(1,timeSteps ...
            ,'like',single(1j));
        correlationFunctionsSecondOrder.(key) = zeros(1,timeSteps ...
            ,'like',double(1j));
        correlationFunctionsSecondOrderSingle.(key) = zeros(1,timeSteps ...
            ,'like',single(1j));
        
        sumCorrelationFunctionsSaverZerothOrder.(key) = zeros( ...
            fibreAnglesThetaCount,fibreAnglesPhiCount,timeSteps,'like' ...
            ,double(1j));
        sumCorrelationFunctionsSaverZerothOrderSingle.(key) = zeros( ...
            fibreAnglesThetaCount,fibreAnglesPhiCount,timeSteps,'like' ...
            ,single(1j));
        sumCorrelationFunctionSaverFirstOrder.(key) = zeros( ...
            fibreAnglesThetaCount,fibreAnglesPhiCount,timeSteps,'like' ...
            ,double(1j));
        sumCorrelationFunctionSaverFirstOrderSingle.(key) = zeros( ...
            fibreAnglesThetaCount,fibreAnglesPhiCount,timeSteps,'like' ...
            ,single(1j));
        sumCorrelationFunctionSaverSecondOrder.(key) = zeros( ...
            fibreAnglesThetaCount,fibreAnglesPhiCount,timeSteps,'like' ...
            ,double(1j));
        sumCorrelationFunctionSaverSecondOrderSingle.(key) = zeros( ...
            fibreAnglesThetaCount,fibreAnglesPhiCount,timeSteps,'like' ...
            ,single(1j));
    end
...
for atomNumber = randomSequenceOfAtoms(atomCounter:atomsToCalculate)
    ...
    for phiNumber = 1:fibreAnglesPhiCount
        ...
        for thetaNumber = 1:fibreAnglesThetaCount
            ...
            % ------------ correlation functions single vs. double precision
            
            tic;
            % double precision zeroth order
            correlationFunctionsZerothOrder ...
                = calculateCorrelationFunctionForDifferentNNCases( ...
                double(sphericalHarmonicZerothOrder) ...
            ...
            sumCorrelationFunctionsSaverZerothOrder ...
                ...
                ,phiNumber);
            % double precision first order
            correlationFunctionsFirstOrder ...
                = calculateCorrelationFunctionForDifferentNNCases( ...
                double(sphericalHarmonicFirstOrder) ...
                ,nearestNeighbourCases);
            sumCorrelationFunctionSaverFirstOrder ...
                ...
                ,phiNumber);
            % double precision second order
            correlationFunctionsSecondOrder ...
                = calculateCorrelationFunctionForDifferentNNCases( ...
                double(sphericalHarmonicSecondOrder) ...
                ,nearestNeighbourCases);
            sumCorrelationFunctionSaverSecondOrder ...
                ...
                ,phiNumber);
            logMessage(sprintf(['Double precision calculation of' ...
                ' correlation function. Time needed: %.2f'],toc) ...
                ,logFilePath,false);
            
            tic;
            % single precision zeroth order
            correlationFunctionsZerothOrderSingle ...
                = calculateCorrelationFunctionForDifferentNNCases( ...
                sphericalHarmonicZerothOrder,nearestNeighbourCases);
            sumCorrelationFunctionsSaverZerothOrderSingle ...
                = addTwoCorrelationFunctionStructs( ...
                sumCorrelationFunctionsSaverZerothOrderSingle ...
                ,correlationFunctionsZerothOrderSingle,thetaNumber ...
                ,phiNumber);
            % single precision first order
            correlationFunctionsFirstOrderSingle ...
                = calculateCorrelationFunctionForDifferentNNCases( ...
                sphericalHarmonicFirstOrder,nearestNeighbourCases);
            sumCorrelationFunctionSaverFirstOrderSingle ...
                = addTwoCorrelationFunctionStructs( ...
                sumCorrelationFunctionSaverFirstOrderSingle ...
                ,correlationFunctionsFirstOrderSingle,thetaNumber ...
                ,phiNumber);
            % single precision second order
            correlationFunctionsSecondOrderSingle ...
                = calculateCorrelationFunctionForDifferentNNCases( ...
                sphericalHarmonicSecondOrder,nearestNeighbourCases);
            sumCorrelationFunctionSaverSecondOrderSingle ...
                = addTwoCorrelationFunctionStructs( ...
                sumCorrelationFunctionSaverSecondOrderSingle ...
                ,correlationFunctionsSecondOrderSingle,thetaNumber ...
                ,phiNumber);
            logMessage(sprintf(['Single precision calculation of ' ...
                ' correlation function. Time needed: %.2f s.'] ...
                ,toc),logFilePath,false);
% ------------------------------------------------------------------------               
