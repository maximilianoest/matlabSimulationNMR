...
%                     ,phiNumber);
                ...
                sumCorrelationFunctionSaverFirstOrder ...
                    ...
                    ,phiNumber);
                logMessage(sprintf('Time for correlation function function: %.2f s.',toc),logFilePath,false);
                
                zeroPaddingLength = 2^(nextpow2(timeSteps)+1);
                fftSphericalHarmonic = fft(double(sphericalHarmonicFirstOrder),zeroPaddingLength,2);
                ...
                logMessage(sprintf('LOG: Correlation function in script: %.2f s.',toc),logFilePath,false);
