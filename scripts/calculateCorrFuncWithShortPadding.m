...
% correlation functions. These have to be imaginary to give the right results.
...
% Additionally, other valdiations are performed: 
% - single vs. double precision
% - differences in zero padding length
...
% ---------- calculate corr func with 2^nexpow(length(CorrFunc)+1))
% This calculation steps was already performed and saved into another
% dataset
...
%                 ,phiNumber);
% ---------- calculate corr func with 2^nexpow(length(CorrFunc)))
            correlationFunctionZerothOrderShortPadding = ...
                calculateCorrFuncForDiffNNCasesWithShortPadding( ...
                sphericalHarmonicZerothOrder,nearestNeighbourCases);
            sumCorrFuncZerothOrderShortPadding = ...
                addTwoCorrelationFunctionStructs( ...
                sumCorrFuncZerothOrderShortPadding ...
                ,correlationFunctionZerothOrderShortPadding,thetaNumber ...
                ,phiNumber);
            correlationFunctionFirstOrderShortPadding = ...
                calculateCorrFuncForDiffNNCasesWithShortPadding( ...
                sphericalHarmonicFirstOrder,nearestNeighbourCases);
            sumCorrFuncFirstOrderShortPadding = ...
                addTwoCorrelationFunctionStructs( ...
                sumCorrFuncFirstOrderShortPadding ...
                ,correlationFunctionFirstOrderShortPadding,thetaNumber ...
                ,phiNumber);
            correlationFunctionSecondOrderShortPadding = ... 
                calculateCorrFuncForDiffNNCasesWithShortPadding( ...
                sphericalHarmonicSecondOrder,nearestNeighbourCases);
            sumCorrFuncSecondOrderShortPadding = ...
                addTwoCorrelationFunctionStructs( ...
                sumCorrFuncSecondOrderShortPadding ...
                ,correlationFunctionSecondOrderShortPadding,thetaNumber ...
                ,phiNumber);
